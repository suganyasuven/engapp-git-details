...
string UPDATE_ISSUES = "UPDATE ENGAPP_GITHUB_ISSUES SET REPOSITORY_ID=?,CREATED_DATE=?,UPDATED_DATE=?,CLOSED_DATE=?, CREATED_BY=?,ISSUE_TYPE=?, HTML_URL=? ,LABELS=? ,ASSIGNEES = ? WHERE GITHUB_ID=?";
